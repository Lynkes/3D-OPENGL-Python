...
class GirlVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront('objects/girl-obj/girl OBJ.obj', cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class HouseVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront('objects/house/cottage_obj.obj', cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
